%%
z=xlsread('G:\OneDrive\nanwang\多区域表21sectors.xlsx',1,'D4: XI633');
X=xlsread('G:\OneDrive\nanwang\多区域表21sectors.xlsx',1,'ADH4: ADH633');
f=xlsread('G:\OneDrive\nanwang\多区域表21sectors.xlsx',2,'CV3: DY632');
bw=xlsread('G:\OneDrive\nanwang\bluewater.xlsx',2,'AX37: BR66');
gw=xlsread('G:\OneDrive\nanwang\greywater.xlsx',3,'A1: U30');
